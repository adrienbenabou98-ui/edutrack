...
### Windows Desktop
**[EduTrack v1.6.0 — Windows Installer](https://github.com/adrienbenabou98-ui/edutrack/releases/tag/v1.6.0)**

| File | Description |
|---|---|
| `EduTrack Setup 1.6.0.exe` | Installer — recommended for most users |
