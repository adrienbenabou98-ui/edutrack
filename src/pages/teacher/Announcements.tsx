    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <nav className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Link to="/teacher/templates" className={NAV_CLS}>Templates</Link>
          <Link to="/teacher/planner" className={NAV_CLS}>Planner</Link>
          <Link to="/teacher/interventions" className={NAV_CLS}>Interventions</Link>
          <Link to="/teacher/announcements" className={ACTIVE_CLS}>Announcements</Link>
          <Link to="/teacher/settings" className={NAV_CLS}>Settings</Link>
