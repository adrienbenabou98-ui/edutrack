...
import { studentProgress, classroomAnalytics, classInsight, teacherQuery } from '../controllers/analytics.controller.js'
...
router.post('/classroom/:classroomId/query', requireRole('TEACHER'), teacherQuery)
